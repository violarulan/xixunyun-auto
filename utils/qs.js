...
const loginApi = 'https://api.xixunyun.com/login/api?from=app&version=4.6.38&platform=1'
const signApi = (token) => {
  return `https://api.xixunyun.com/signin_rsa?token=${token}&from=app&version=4.6.38&platform=1&entrance_year=0&graduate_year=0&school_id=${process.env.SCHOOL_ID}`
}
